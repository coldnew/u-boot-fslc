...
static void spl_mx6dl_dram_setup_iomux(void)
{
	...
	mx6dl_ddr_iomux->dram_sdclk_0 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdclk_1 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_cas = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_ras = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_addds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_reset = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdcke0 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdcke1 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdba2 = (u32)0x00000000;
	mx6dl_ddr_iomux->dram_sdodt0 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdodt1 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_ctlds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_ddrmode_ctl = (u32)0x00020000;
	mx6dl_ddr_iomux->dram_sdqs0 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdqs1 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdqs2 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdqs3 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdqs4 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdqs5 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdqs6 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_sdqs7 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_ddrmode = (u32)0x00020000;
	mx6dl_grp_iomux->grp_b0ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_b1ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_b2ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_b3ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_b4ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_b5ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_b6ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_grp_iomux->grp_b7ds = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm0 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm1 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm2 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm3 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm4 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm5 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm6 = (u32)DRIVE_STRENGTH_IMX6DL;
	mx6dl_ddr_iomux->dram_dqm7 = (u32)DRIVE_STRENGTH_IMX6DL;
}
...
static void spl_dram_init_mx6solo_512mb(void)
{
	...
	/* Write leveling */
	mmdc_p0->mpwldectrl0 = (u32)0x0053005A;
	mmdc_p0->mpwldectrl1 = (u32)0x00430048;

	mmdc_p0->mpdgctrl0 = (u32)0x024C0244;
	mmdc_p0->mpdgctrl1 = (u32)0x0234023C;
	mmdc_p0->mprddlctl = (u32)0x3E484A44;
	mmdc_p0->mpwrdlctl = (u32)0x3A38302E;
	/* Read data bit delay */
...
static void spl_dram_init_mx6dl_1g(void)
{
	...
	/* write leveling */
	mmdc_p0->mpwldectrl0 = (u32)0x003E0047;
	mmdc_p0->mpwldectrl1 = (u32)0x00300036;
	mmdc_p1->mpwldectrl0 = (u32)0x0018001B;
	mmdc_p1->mpwldectrl1 = (u32)0x0010002C;

	/* DQS gating, read delay, write delay calibration values
	based on calibration compare of 0x00ffff00 */
	mmdc_p0->mpdgctrl0 = (u32)0x02380234;
	mmdc_p0->mpdgctrl1 = (u32)0x02300230;
	mmdc_p1->mpdgctrl0 = (u32)0x0218021C;
	mmdc_p1->mpdgctrl1 = (u32)0x0210020C;
	mmdc_p0->mprddlctl = (u32)0x40464846;
	mmdc_p1->mprddlctl = (u32)0x40444640;
	mmdc_p0->mpwrdlctl = (u32)0x3A302E30;
	mmdc_p1->mpwrdlctl = (u32)0x3630302C;
	/* read data bit delay */
	mmdc_p0->mprddqby0dl = (u32)0x33333333;
	mmdc_p0->mprddqby1dl = (u32)0x33333333;
	mmdc_p0->mprddqby2dl = (u32)0x33333333;
...
static void spl_dram_init_mx6q_2g(void)
{
	...
	/* DQS gating, read delay, write delay calibration values
	 based on calibration compare of 0x00ffff00  */
	mmdc_p0->mpdgctrl0 = (u32)0x032C0340;
	mmdc_p0->mpdgctrl1 = (u32)0x03300324;
	mmdc_p1->mpdgctrl0 = (u32)0x032C0338;
	mmdc_p1->mpdgctrl1 = (u32)0x03300274;
	
	mmdc_p0->mprddlctl = (u32)0x423A383E;
	mmdc_p1->mprddlctl = (u32)0x3638323E;

	mmdc_p0->mpwrdlctl = (u32)0x363C4640;
	mmdc_p1->mpwrdlctl = (u32)0x4034423C;
